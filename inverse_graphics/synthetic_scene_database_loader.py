...
and a data mapper for that database to load it into Instances for training.
...
"""
    ...
    ann_keys = ["iscrowd", "bbox", "keypoints", "category_id", "object_sdf", "pose", "parameters", "score"]
