...
if __name__ == "__main__":
    ...
    for _ in range(100):
        ...
        try:
            ...
            with open("generated_planar_bin_static_scenes_stacks_tall_raw.yaml", "a") as file:
                yaml.dump({env_name:
                          scene_yaml}, file, Dumper=noalias_dumper)
            with open("generated_planar_bin_static_scenes_stacks_tall_nonpen.yaml", "a") as file:
                yaml.dump({env_name:
                          scene_nonpen}, file, Dumper=noalias_dumper)
            with open("generated_planar_bin_static_scenes_stacks_tall_static.yaml", "a") as file:
                yaml.dump({env_name:
